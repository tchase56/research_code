...
if load_address == r'C:\Users\tchase56\Documents\UED\Gold_Diffuse_03212016\20160512\long_scan\\':
    if different_scans == 2:
        np.save(save_address + 'diffuse_long_expanded_norm_ROI2.npy', diffuse)
    elif different_scans == 3:
        np.save(save_address + 'diffuse_long_expanded_ROI2.npy', diffuse)
    elif different_scans == 4:
        np.save(save_address + 'diffuse_long_norm_ROI2.npy', diffuse)
    elif different_scans == 5:
        np.save(save_address + 'diffuse_long_ROI2.npy', diffuse)
    else:
        np.save(save_address + 'diffuse_l_ROI2.npy', diffuse)    
else:
    if different_scans == 2:
        np.save(save_address + 'diffuse_short_expanded_norm_ROI2.npy', diffuse)
    if different_scans == 3:
        np.save(save_address + 'diffuse_short_expanded_ROI2.npy', diffuse)
    if different_scans == 4:
        np.save(save_address + 'diffuse_short_norm_ROI2.npy', diffuse)
    elif different_scans == 5:
        np.save(save_address + 'diffuse_short_ROI2.npy', diffuse)
    else:
        np.save(save_address + 'diffuse_s_ROI2.npy', diffuse)   

...
lineScan_short = np.load(lineScan_short_address + 'diffuse_short_expanded_ROI3.npy')
lineScan_long = np.load(lineScan_long_address + 'diffuse_long_expanded_ROI3.npy')
...
lower = 28
upper = 116
length = 8     # must be factor of 204-29 = 175 choose (1,5,7,25,35,175)

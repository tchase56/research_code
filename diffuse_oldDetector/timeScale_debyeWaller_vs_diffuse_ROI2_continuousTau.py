...
lineScan_short = np.load(lineScan_short_address + 'diffuse_short_expanded_ROI2.npy')
lineScan_long = np.load(lineScan_long_address + 'diffuse_long_expanded_ROI2.npy')
...
lower = 26
upper = 126
length = 10     # must be factor of 204-29 = 175 choose (1,5,7,25,35,175)
